...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\N-gram_Uni-gram List--final version - Bellarmine_TrentPersecution_Bigram.csv)")
head(table)
```
...
p = table_pivot |>
  ...
  labs(
    title = "Discourse of Trentian Counter-Reformation Changed With Different Reigns",
    x = "Date", 
    y = "N-gram Frequency",
    color = "N-gram"
  ) 
...
ggplotly(p) |>
  layout(annotations = 
    list(x = 1.23, y = -.25, text = 
        "* King James was \n coronated in 1603, \n as was King Charles \n in 1625.
** Bigrams relate \n to the Council of \n Trent, a milestone in the \n Counter-Reformation.", 
