...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\N-gram_Uni-gram List--final version - Bellarmine_PopishPersecution_Bigram.csv)")
head(table)
```
...
p = table_pivot |>
  ...
  labs(
    title = "Discourse of Popish Counter-Reformation Changed With Different Reigns",
    x = "Date", 
    y = "N-gram Frequency",
    color = "N-gram"
  ) 
