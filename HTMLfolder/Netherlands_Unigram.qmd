...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\N-gram_Uni-gram List--final version - Netherlands_Unigram.csv)")
head(table)
```
...
p = table_pivot |>
  ...
  labs(
    title = "Netherlands Unigrams in Focused Corpus",
