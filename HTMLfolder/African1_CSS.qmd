...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\whole corpus lexicon sheets - african 1.csv)")
head(table)
```
...
p = table_pivot |>
  ...
  scale_color_manual(values = c("#d5b4b4", "#d5cfb4", "#cad5b4", "#b6d5b4", "#ff9900", "#4bd891", "#cab4d5", "#b4d1d5", "#000000")) +
  labs(
    x = "Date",
