...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\N-gram_Uni-gram List--final version - WestIndies_Unigram.csv)")
head(table)
```
...
p = table_pivot |>
  ...
  labs(
    title = "West Indies Unigrams Over Time in Focused Corpus",
    x = "Date", 
    y = "Unigram Frequency",
    color = "Unigram"
  ) 
