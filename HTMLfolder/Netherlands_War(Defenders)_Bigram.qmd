...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\N-gram_Uni-gram List--final version - Netherlands_War(Defenders)_Bigram.csv)")
head(table)
```
...
p = table_pivot |>
  ...
  annotate("text", x = 1.7, y = 15, label = "Areas shaded in gray are \n periods when England sent \n troops to the Netherlands.", fontface = "italic", size = 2.3) +
  annotate("rect", xmin = .3, xmax = 3, ymin = 0, ymax = 20, alpha = .25) +
  annotate("rect", xmin = 8, xmax = 9, ymin = 0, ymax = 20, alpha = .25) +
  annotate("rect", xmin = 3.5, xmax = 4.5, ymin = 0, ymax = 20, fill = "red", alpha = .25) +
  labs(
    title = "Netherlands Defense Bigrams in Focused Corpus",
...
ggplotly(p) |>
  layout(annotations = 
    list(x = 1.34, y = 0, text = "
         * N-grams used relate to the \n Netherlands' defense in \n the 80 Years' War.
