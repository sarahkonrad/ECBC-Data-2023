...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\N-gram_Uni-gram List--final version - Portugal_Unigram.csv)")
head(table)
```
...
p = table_pivot |>
  ...
  labs(
    title = "Discourse of Portugal Unigrams in Focused Corpus",
    x = "Date", 
    y = "Unigram Frequency",
    color = "Unigram"
  ) 
