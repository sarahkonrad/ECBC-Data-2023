...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\whole corpus lexicon sheets - spain 2.csv)")
head(table)
```
...
p = table_pivot |>
  ...
  scale_color_manual(values = c("#d5b4b4", "#cad5b4", "#8f34ea", "#cab4d5", "#b4d1d5", "#ffbf00", "#ff3884")) +
  labs(
    x = "Date",
