...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\subcorpus sheets - irish 1.csv)")
head(table)
```
...
p = table_pivot |>
  ...
  scale_color_manual(values = c("#d5b4b4", "#000000", "#cad5b4", "#ff9900", "#0033cc", "#cab4d5")) +
  labs(
    x = "Date",
