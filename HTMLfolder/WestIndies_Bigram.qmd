...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\N-gram_Uni-gram List--final version - WestIndies_Bigram.csv)")
head(table)
```
...
p = table_pivot |>
  filter(ngram %in% c("enter_guyana", "guyana_take", "cannibal_island", "among_cannibal", "conquer_guyana", "conquest_guyana", "discovery_guyana")) |>
  ...
  labs(
    title = "West Indies N-grams Over Time in Focused Corpus",
    x = "Date", 
    y = "N-gram Frequency",
    color = "N-gram"
  ) 
