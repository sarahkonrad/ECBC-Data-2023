...
table = read.csv(r"(C:\Users\bqueu\Documents\R\ECBC Graphs\N-gram_Uni-gram List--final version - Indentured_Bigram.csv)")
head(table)
```
...
p = table_pivot |>
  filter(ngram %in% c("idle_person", "servant_apprentice", "contract_young", "contract_servant", "servant_tenant")) |>
  ...
  labs(
    title = "Indentured N-grams Over Time in Focused Corpus",
    x = "Date", 
    y = "N-gram Frequency",
    color = "N-gram"
  ) 
